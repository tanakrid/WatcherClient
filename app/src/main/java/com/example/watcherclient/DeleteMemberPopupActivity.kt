...
class DeleteMemberPopupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_delete_member_popup)
        ...
        val member_id = bundle?.getString("member_id", "")
        ...
        submitButton.setOnClickListener {
            if (room_id != null) {
                if (member_id != null) {
                    viewModel.removeMember(user_id, room_id, member_id)
                }
            }
            onBackPressed()
        }
